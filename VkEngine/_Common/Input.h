...
private:
	...
	static int32_t mousePosition[2];
...
public:
	...
	static void Update()
	{
		...
		mouseDelta[0] = (int32_t)mousePos.x - mousePosition[0];
		mouseDelta[1] = (int32_t)mousePos.y - mousePosition[1];

		mousePosition[0] = (int32_t)mousePos.x;
		mousePosition[1] = (int32_t)mousePos.y;
	}
